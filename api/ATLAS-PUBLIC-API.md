...
## Faculty Assignments (Teaching Load)
...
### Current Live Teaching Load Contract

The simplified examples above are legacy-minimal examples.
...
- section-assigned classes, derived from `faculty[].assignments[]`
- coverage totals
- integrity diagnostics

Current top-level response fields include:
...
Use this endpoint for teacher-specific live teaching-load sessions.
...
- `MISSING_OWNERSHIP`: stored scope exists but ownership rows are currently missing
