...
export const VIOLATION_PRESENTATION: Record<ViolationCode, ViolationPresentation> = {
	...
	ZONE_IMBALANCE_WARNING: { title: 'Most classes are in one campus zone', meaning: 'More than half of this term’s zoned classes sit in the same campus zone.', action: 'Move some of this term’s classes to rooms in another campus zone, or keep the schedule if the concentration is intended.' },
