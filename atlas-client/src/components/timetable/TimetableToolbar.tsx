...
export function TimetableToolbar({
	...
	return (
		<div className="flex items-center gap-2 overflow-x-auto px-4 pb-1.5 xl:flex-wrap [@media(max-height:500px)]:hidden scrollbar-thin" data-tutorial="grid-controls">
