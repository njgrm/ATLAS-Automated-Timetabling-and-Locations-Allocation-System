...
interface TestCase {
	...
	auth: boolean;
	expectStatus: number;
	/** Optional check on response body */
	expectShape?: (body: unknown) => string | null;
}
...
const tests: TestCase[] = [
	...
	},
	{
		...
		expectStatus: 200,
		expectShape: (b) => {
			const r = b as { buildings?: unknown[] };
