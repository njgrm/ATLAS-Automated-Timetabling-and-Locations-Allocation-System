...
function benchGrade(
	displayOrder: number,
	sections: Array<{ id: number; name: string; enrolledCount: number; adviserId: number; adviserName: string }>,
): SectionsByGrade {
	return {
...
const FIXTURE_INPUT: ConstructorInput = {
	schoolId: 1,
	schoolYearId: 1,
	sectionsByGrade: [
		benchGrade(7, [
	...
	subjects: [
		{ id: 1, code: 'ENG', minMinutesPerWeek: 200, preferredRoomType: 'CLASSROOM', sessionPattern: 'ANY', gradeLevels: [7, 8, 9, 10] },
		{ id: 2, code: 'MATH', minMinutesPerWeek: 250, preferredRoomType: 'CLASSROOM', sessionPattern: 'MWF', gradeLevels: [7, 8, 9, 10] },
		{ id: 3, code: 'SCI', minMinutesPerWeek: 200, preferredRoomType: 'LABORATORY', sessionPattern: 'TTH', gradeLevels: [7, 8, 9, 10] },
		{ id: 4, code: 'FIL', minMinutesPerWeek: 200, preferredRoomType: 'CLASSROOM', sessionPattern: 'ANY', gradeLevels: [7, 8, 9, 10] },
		{ id: 5, code: 'AP', minMinutesPerWeek: 100, preferredRoomType: 'CLASSROOM', sessionPattern: 'TTH', gradeLevels: [7, 8, 9, 10] },
		{ id: 6, code: 'ESP', minMinutesPerWeek: 100, preferredRoomType: 'CLASSROOM', sessionPattern: 'ANY', gradeLevels: [7, 8] },
		{ id: 7, code: 'MAPEH', minMinutesPerWeek: 200, preferredRoomType: 'CLASSROOM', sessionPattern: 'ANY', gradeLevels: [7, 8, 9, 10] },
		{ id: 8, code: 'TLE', minMinutesPerWeek: 200, preferredRoomType: 'TLE_WORKSHOP', sessionPattern: 'TTH', gradeLevels: [7, 8, 9, 10] },
		{ id: 9, code: 'HG', minMinutesPerWeek: 50, preferredRoomType: 'CLASSROOM', sessionPattern: 'ANY', gradeLevels: [7, 8, 9, 10] },
	],
	faculty: [
...
function runBaseline(input: ConstructorInput): BenchmarkRun {
...
const hybridRuns: Array<BenchmarkRun & { selectedProfile: string; seedCount: number }> = [];
...
function gate(condition: boolean, label: string) {
