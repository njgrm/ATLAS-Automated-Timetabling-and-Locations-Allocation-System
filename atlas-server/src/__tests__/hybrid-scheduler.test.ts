...
section('H-ALG-1-02 runHybridScheduler seedQuality profiles are deterministic');
{
	const input: ConstructorInput = {
		...
		subjects: [
			{ id: 1, code: 'MATH', minMinutesPerWeek: 150, preferredRoomType: 'CLASSROOM' as const, gradeLevels: [7] },
			{ id: 2, code: 'SCI', minMinutesPerWeek: 100, preferredRoomType: 'LABORATORY' as const, gradeLevels: [7] },
		],
		faculty: [],
		facultySubjects: [],
		rooms: [],
...
section('H-ALG-1-03 runHybridScheduler selects profile with fewest unassigned');
{
	...
	const input: ConstructorInput = {
		...
		subjects: [
			{ id: 1, code: 'ENG', minMinutesPerWeek: 200, preferredRoomType: 'CLASSROOM' as const, gradeLevels: [7, 8] },
		],
		faculty: [],
		facultySubjects: [],
		rooms: [],
