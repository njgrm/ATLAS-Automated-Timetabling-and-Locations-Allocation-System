import { fetchEnrollProActiveTerm, type ActiveTermResult } from '../services/active-term-adapter.service.js';
...
function teardownEnv(env: { originalToken: string | undefined; originalApi: string | undefined; originalFetch: typeof globalThis.fetch }) {
...

{
	...
	globalThis.fetch = async (_url: string | URL | Request | undefined, init: RequestInit | undefined) => {
...
function cloneActiveTerm(overrides: Partial<ActiveTermResult>): ActiveTermResult {
	return {
...
function applyRuntimeContextGuard(
	activeTermResult: ActiveTermResult,
	upstreamYear: { id: number } | null,
): ActiveTermResult {
