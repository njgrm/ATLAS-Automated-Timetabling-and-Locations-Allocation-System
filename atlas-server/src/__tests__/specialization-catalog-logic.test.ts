import {
	type SpecializationCatalogDepartment,
	type SpecializationCatalogItem,
...
function classifyLikeCatalog(item: SpecializationCatalogItem): 'mapped' | 'partially_mapped' | 'unmapped' {
...
function run() {
	...
	const mapped: SpecializationCatalogItem = {
	...
	const partial: SpecializationCatalogItem = {
	...
	const unmapped: SpecializationCatalogItem = {
	...
	const departments: SpecializationCatalogDepartment[] = [
		{
			departmentCode: 'SCI',
			departmentName: 'Science',
