...
import { getEffectiveEvents, normalizeProgramType, type SpecialEventRow } from '../services/policy-special-event.service.js';
...
function makeRow(overrides: Partial<SpecialEventRow> & { eventType: string }): SpecialEventRow {
	return {
		id: 1,
		schoolId: 1,
		schoolYearId: 2,
