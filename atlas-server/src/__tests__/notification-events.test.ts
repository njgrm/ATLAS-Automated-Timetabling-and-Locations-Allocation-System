...
function run() {
	...
	let termEvents: NotificationEvent[] = [];
	...
	assertEqual((genEvent?.metadata as any)?.termCounts?.term1, 50, 'Generation metadata has termCounts.term1');
	assertEqual((genEvent?.metadata as any)?.termCounts?.term2, 30, 'Generation metadata has termCounts.term2');
	assertEqual((genEvent?.metadata as any)?.termCounts?.term3, 25, 'Generation metadata has termCounts.term3');
	...
	assertEqual((pubEvent?.metadata as any)?.termCounts?.term1, 50, 'Publish metadata has termCounts.term1');
	...
	assertEqual(Array.isArray((revEvent?.metadata as any)?.affectedTermIndices), true, 'Revision metadata has affectedTermIndices array');
	assertEqual((revEvent?.metadata as any)?.affectedTermIndices?.includes(1), true, 'Revision metadata includes term 1');
	assertEqual((revEvent?.metadata as any)?.affectedTermIndices?.includes(2), true, 'Revision metadata includes term 2');
	...
	assertEqual((editEvent?.metadata as any)?.termIndex, 1, 'Single edit metadata has termIndex=1');
	...
	assertEqual(Array.isArray((batchEvent?.metadata as any)?.affectedTermIndices), true, 'Batch edit metadata has affectedTermIndices array');
	assertEqual((batchEvent?.metadata as any)?.affectedTermIndices?.includes(1), true, 'Batch edit metadata includes term 1');
	assertEqual((batchEvent?.metadata as any)?.affectedTermIndices?.includes(3), true, 'Batch edit metadata includes term 3');
	...
	assertEqual((revertEvent?.metadata as any)?.termIndex, 2, 'Revert metadata has termIndex=2');
	...
	assertEqual((noTermEvent?.metadata as any)?.termIndex, undefined, 'No-term edit metadata has termIndex=undefined');
	assertEqual((noTermEvent?.metadata as any)?.affectedTermIndices, undefined, 'No-term edit metadata has affectedTermIndices=undefined');
