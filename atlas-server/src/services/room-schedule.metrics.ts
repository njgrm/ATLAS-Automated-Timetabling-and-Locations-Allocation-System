 ...
 */
export function computeOccupiedMinutesByIntervalUnion(
	entries: TimeIntervalEntry[],
	days: readonly string[],
): number {
	const entriesByDay = new Map<string, TimeIntervalEntry[]>();
...
export function countUniqueEntryIds(entries: Array<{ entryId: string }>): number {
