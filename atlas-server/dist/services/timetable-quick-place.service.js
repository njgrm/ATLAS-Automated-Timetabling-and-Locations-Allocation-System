...
export async function applyQuickPlace(runId, schoolId, schoolYearId, actorId, expectedVersion) {
    ...
    const finalEntries = commitRes.draft.entries;
    const finalUnassigned = commitRes.draft.unassignedItems;
    ...
    const currentSummary = (commitRes.draft.summary ?? {});
...
//# sourceMappingURL=timetable-quick-place.service.js.map