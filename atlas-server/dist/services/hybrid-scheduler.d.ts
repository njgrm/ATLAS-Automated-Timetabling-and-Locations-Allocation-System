...
export type SeedProfileId = 'GRADE_ASC_SUBJECT_ASC' | 'MOST_CONSTRAINED_FIRST' | 'GRADE_DESC_SUBJECT_ASC' | 'SESSION_PATTERN_PRIORITY' | 'PACKED_BLOCK_PRIORITY' | 'LOAD_DENSITY_SLOT_PRIORITY';
