...
export declare function matchesSubjectOwnershipDepartment(facultyDepartment: string | null | undefined, subjectCode: string | null | undefined, subjectName?: string | null, explicitOwnerDepartment?: string | null): boolean;
