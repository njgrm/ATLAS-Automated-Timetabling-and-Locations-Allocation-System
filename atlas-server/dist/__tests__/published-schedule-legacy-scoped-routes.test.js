    ...
    try {
        ...
        if (historicalPublished) {
            ...
            for (const e of entries) {
                if (e.sectionId != null)
                    sectionIds.add(Number(e.sectionId));
                if (e.facultyId != null)
                    facultyIds.add(Number(e.facultyId));
                if (e.roomId != null)
                    roomIds.add(Number(e.roomId));
            }
        ...
        if (historicalPublished && testSectionId != null && testFacultyId != null && testRoomId != null) {
            ...
            const hasOtherSection = histEntries.some((e) => {
...
run();
//# sourceMappingURL=published-schedule-legacy-scoped-routes.test.js.map