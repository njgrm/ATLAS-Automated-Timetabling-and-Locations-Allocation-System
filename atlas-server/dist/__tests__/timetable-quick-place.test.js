...
async function run() {
    ...
    try {
        ...
        const entryHome = dbEntries.find((e) => e.subjectId === subject.id && e.day === 'MONDAY' && e.startTime === '08:00');
        const entryPreferred = dbEntries.find((e) => e.subjectId === subject.id && e.day === 'MONDAY' && e.startTime === '09:00');
        const entryFallback = dbEntries.find((e) => e.subjectId === subjectFallback.id && e.day === 'TUESDAY' && e.startTime === '08:00');
