...
}
{
    ...
    assert(result.errors.some((e) => e.includes('at least 50 minutes')), 'Too-short-window error message is explicit');
}
{
    const result = validatePolicyInput({
...
//# sourceMappingURL=scheduling-policy.validation.test.js.map