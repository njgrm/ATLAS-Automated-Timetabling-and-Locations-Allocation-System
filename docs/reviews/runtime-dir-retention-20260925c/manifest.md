...
must not start until this audited reclaim runs and capacity is rechecked. E: remains above the 25 GiB
fail-closed line.
...
|---:|---|---|---|---|---|---:|---:|
| 1 | `E:\ATLAS-runtime-supervised-ad8f9717-20260925` | `ad8f971787cd004d9aeb040d362a9acd3e290074` | `?? ops/runtime/logs/` only | yes | none | 0 | 1.46 GiB |
| 2 | `E:\ATLAS-runtime-supervised-82871619-20260925` | `82871619de4a031ba0d79c116db67b2fef00e2b2` | `?? ops/runtime/logs/` only | yes | none | 0 | 1.46 GiB |
| 3 | `E:\ATLAS-runtime-supervised-ff87b06b-20260925` | `ff87b06bfb33dee5817a357ad0080d9338c5106e` | `?? ops/runtime/logs/` only | yes | none | 0 | 1.48 GiB |
...
2. Remove only the untracked `ops/runtime/logs/` directory after confirming it is not the active
   supervisor state for the live release.
