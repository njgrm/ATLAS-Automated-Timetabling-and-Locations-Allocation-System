...
The reference workbook is `stakeholderFiles/root-reference/SUMMARY-AND-TEACHERS-SCHEDULE-PER-SUBJECT-2026-2027.xlsx`. It is a target reporting shape, not a source of scheduling truth.

Additional reference files inspected on 2026-08-15:

- `stakeholderFiles/root-reference/aral-prog_G7_Class-Program_SY2026-2027docx.docx`
- `stakeholderFiles/root-reference/40-minutes.xlsx`
