...
| shortName | VARCHAR | --- | Short name or abbreviation for the school. |
...
| short_code | VARCHAR | --- | Optional; short building code. |
...
| school_id | INT (FK) | --- | Reference to the owning school. |
| code | VARCHAR | --- | Subject code (unique within the school). |
...
| role | VARCHAR | --- | Role label for access control. |
...
| entry_id | VARCHAR | --- | Entry identifier from the generation draft. |
...
| run_type | VARCHAR | --- | Run type label (e.g., FULL). |
...
| run_id | INT (FK) | --- | Reference to the generation run. |
| entry_id | VARCHAR | --- | Entry identifier in the draft schedule. |
...
| cohort_code | VARCHAR | --- | Optional; cohort code for grouped sessions. |
...
| action_type | VARCHAR | --- | Action type label. |
...
| school_id | INT (FK) | --- | Reference to the owning school. |
| school_year_id | INT | --- | School year context identifier. |
| cohort_code | VARCHAR | --- | Cohort code identifier. |
| specialization_code | VARCHAR | --- | Specialization code. |
