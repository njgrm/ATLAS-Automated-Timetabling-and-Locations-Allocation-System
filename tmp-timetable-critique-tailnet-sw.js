...
(async () => {
    ...
    // Ignore HTTPS errors and use a clean context
    const context = await browser.newContext({ viewport: { width: 1440, height: 900 }, ignoreHTTPSErrors: true });
    
    // Block service worker registration completely to bypass the 3-second timeout bug
    ...
    try {
        ...
        // Ensure any existing SW are unregistered
