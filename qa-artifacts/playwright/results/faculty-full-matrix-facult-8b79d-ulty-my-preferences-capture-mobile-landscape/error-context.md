...
- Name: faculty-full-matrix.spec.ts >> faculty full matrix (logged-in) >> faculty /my/preferences capture
- Location: qa-artifacts\playwright\specs\faculty-full-matrix.spec.ts:47:9

# Error details

```
Error: A snapshot doesn't exist at D:\ATLAS\qa-artifacts\playwright\snapshots\faculty-full-matrix.spec.ts\mobile-landscape\faculty-preferences-mobile-landscape.png, writing actual.
```
