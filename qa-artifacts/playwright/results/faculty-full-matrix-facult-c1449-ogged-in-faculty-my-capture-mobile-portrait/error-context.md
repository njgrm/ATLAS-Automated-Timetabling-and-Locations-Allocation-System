...
```
Error: A snapshot doesn't exist at D:\ATLAS\qa-artifacts\playwright\snapshots\faculty-full-matrix.spec.ts\mobile-portrait\faculty-my-mobile-portrait.png, writing actual.
```
