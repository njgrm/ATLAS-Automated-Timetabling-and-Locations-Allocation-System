...
```
Error: A snapshot doesn't exist at D:\ATLAS\qa-artifacts\playwright\snapshots\faculty-full-matrix.spec.ts\mobile-landscape\faculty-my-mobile-landscape.png, writing actual.
```
  ...
  - main [ref=e4]:
    - generic [ref=e5]:
      - button "Open navigation menu" [ref=e6]:
        - img
        - generic [ref=e7]: Open navigation menu
      - generic [ref=e8]: My Dashboard
      - generic [ref=e9]:
        - img [ref=e10]
        - text: Online
