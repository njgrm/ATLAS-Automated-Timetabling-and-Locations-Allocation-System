...
```
Error: A snapshot doesn't exist at D:\ATLAS\qa-artifacts\playwright\snapshots\faculty-full-matrix.spec.ts\desktop\faculty-preferences-desktop.png, writing actual.
```
