...
```
Error: A snapshot doesn't exist at D:\ATLAS\qa-artifacts\playwright\snapshots\faculty-full-matrix.spec.ts\mobile-landscape\faculty-room-preferences-mobile-landscape.png, writing actual.
```
