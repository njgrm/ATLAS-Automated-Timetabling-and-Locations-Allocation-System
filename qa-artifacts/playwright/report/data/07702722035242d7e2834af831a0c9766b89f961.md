...
```
Error: A snapshot doesn't exist at D:\ATLAS\qa-artifacts\playwright\snapshots\faculty-full-matrix.spec.ts\mobile-portrait\faculty-preferences-mobile-portrait.png, writing actual.
```
